...
require( get_template_directory() . '/inc/slider/_s_slider_post_type.php' );
// Create Slider
require( get_template_directory() . '/inc/slider/_s_slider.php' );
...
function twentytwelve_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Servizi', 'twentytwelve' ),
		'id' => 'sidebar-4',
		'description' => __( 'Appears when using the optional Servizi template', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
/**
 * Register Custom Taxonomy for Woothemes Features Plugin
 *
 * @since Twenty Twelve 1.0
 */
